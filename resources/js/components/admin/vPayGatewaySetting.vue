                         ...
                         <form @submit.prevent="createProduct()">
                          <div class="form-group row">
                               <div class="col-sm-4">
                                 ...
                                 <div class="col-sm-4">
                                    <label class="col-form-label">Website Type</label>
                                    <input type="text"  class="form-control"  v-model="iform.other" placeholder="" :class="{ 'is-invalid': errors.other }">
                            ...
                            <div class="form-group row">
                               <div class="col-sm-4">
                                 ...
                                 <div class="col-sm-4">
                                    <label class="col-form-label">Environment Type</label>
                                    <input type="text"  class="form-control"  v-model="iform.other" placeholder="" :class="{ 'is-invalid': errors.other }">
        ...
        <hr>
           <div class="row mt-3">
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title"> Razorpay - Payment Gateway Settings</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body p-3">
                         <form @submit.prevent="createProduct()">

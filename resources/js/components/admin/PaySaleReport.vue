            ...
            <div class="col-12 col-xs-12 mt-2">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-2 col-md-2 p-0">
                        ...
                        <has-error :form="to" field="to"></has-error>
                    </div>

                    <label for="staticEmail" class=" col-sm-2 col-form-label" style="font-size:14px!important;text-align:right!important">Payment Mode</label>
                    <div class="col-sm-2 col-md-2 p-0">
                        <select v-model="form.payment_mode" class="form-control fmcntrl1"  :class="{ 'is-invalid': form.errors.has('payment_mode') }">
                            <option value="Bank" >Bank</option>
                            <option value="Card" >Card</option>
                            <option value="Upi" >Upi</option>
                            <option value="Cash">Cash</option>
                        </select>
                        <has-error :form="to" field="payment_mode"></has-error>
                    </div>
        ...
        <div class="row mt-3" >
            <div class="col-12">
                <div class="card p-1" ref="report">
                    ...
                    <div class="card-header">
                        <h3 class="card-title mb-0 w-100 bg-dark text-center">Sales Report (Payment Mode wise)</h3>
                    </div>
                    <!-- /.card-header -->
...
export default {
    ...
    methods :{
        ...
        {
            $("table").table2excel({
                filename: "payment wise sale report.xls"
            });
        },
        loadOrderStatus() {

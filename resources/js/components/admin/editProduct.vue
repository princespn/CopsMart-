            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title ml-2"> Edit Item/ Product</h3>
                    </div>
                    <!-- /.card-header -->
                         ...
                         <form @submit.prevent="updateProduct()">
                            <div class="form-group row">
                                <div class="col-sm-4">
                                 ...
                                 <div class="col-sm-4">
                                    ...
                                    <input type="text"  id="hsnd"  v-on:keyup="checkhsn()" class="form-control"  v-model="iform.hsn" placeholder="HSN Code" :class="{ 'is-invalid': errors.hsn }">
                            ...
                            <div class="form-group row" >
                                <div class="col-sm-4">
                                    ...
                                    <input type="text"  class="form-control"  v-model="iform.weight" placeholder="Item / Product Weight" :class="{ 'is-invalid': errors.weight }">
                            ...
                            <div class="form-group row">  
                                <div class="col-sm-4">
                                    ...
                                    <span class="label label-danger" v-if="errors.tags">{{errors.tags}} </span>
                                </div>
                            ...
                            <div class="form-group row">  
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <span class="label label-danger" v-if="errors.size">{{errors.sub_sub_category_id}} </span>
                                </div>
                              ...
                              <div class="form-group row">  
                                 <div class="col-sm-4">
                                    ...
                                    <input type="text" v-on:keyup="checkmrp()" id="mrpdata"   class="form-control"  v-model="iform.mrp" placeholder="Other Details" :class="{ 'is-invalid': errors.mrp }">
                                    <span class="label label-danger" v-if="errors.mrp">{{errors.mrp}} </span>
                                </div>

                                <div class="col-sm-4">
                                    <label class="col-form-label">Hide Products</label>
                            ...
                            <!-- ------------- -->
                             ...
                             <div class="form-group row"> 
                                ...
                                <div class="col-sm-2" style="margin-left:5px!important">
                                    ...
                                    <input ref="fileInput1" class="form-control" @change="fileSelected1" type="file" @input="pickFile1" >
                                 ...
                                 <div class="col-sm-2" style="margin-left:5px!important">
                                    <label class="col-form-label text-center">Image2</label>
                                     <input ref="fileInput2" class="form-control" @change="fileSelected2" type="file" @input="pickFile2" >
                                    <span class="label label-danger" v-if="errors.image">{{errors.image}} </span>
                                    <br/>
                                ...
                                <div class="col-sm-2" style="margin-left:5px!important">
                                    ...
                                    <input ref="fileInput3" class="form-control" @change="fileSelected3" type="file" @input="pickFile3" >
                                    <span class="label label-danger" v-if="errors.image">{{errors.image}} </span>
                                    <br/>
                                ...
                                <div class="col-sm-2" style="margin-left:5px!important">
                                    ...
                                    <input ref="fileInput4" class="form-control" @change="fileSelected4" type="file" @input="pickFile4" >
                                    <span class="label label-danger" v-if="errors.image">{{errors.image}} </span>
                                    <br/>
                                ...
                                <div class="col-sm-2" style="margin-left:5px!important">
                                    ...
                                    <input ref="fileInput5" class="form-control" @change="fileSelected5" type="file" @input="pickFile5" >
                                    <span class="label label-danger" v-if="errors.image">{{errors.image}} </span>
                                    <br/>
...
import { log } from 'util';
    export default {
        ...
        methods :{
            ...
            editForm(data){
                ...
                if(data.tags!=''){
                    var tags = data.tags.split(',');
                     var tname = data.tag_name.split(',');
                    for (let x in tags){
                        this.selected.push({'id':tags[x],'name':tname[x]});
                    }
                }
                if(data.size!=''){
                    // this.iform.attributex=data.size;
                    var size = data.size.split(',');
                     var sname = data.size_name.split(',');
                    for (let x in size){
                        this.selectedsize.push({'id':size[x],'name':sname[x]});
                       
                    }
                }

                if(data.color!=''){
                    //    this.iform.attributesub=data.color;
                    var color = data.color.split(',');
                     var cname = data.color_name.split(',');
                    for (let x in color){
                        this.selectedcolor.push({'id':color[x],'name':cname[x]});
                    }
                }

                if(data.image1!='')
                {
                    this.previewImage1='/public/uploads/images/product/' + data.image1;
                }
                if(data.image2!='')
                {
                    this.previewImage2='/public/uploads/images/product/' + data.image2;
                }
                if(data.image3!='')
                {
                    this.previewImage3='/public/uploads/images/product/' + data.image3;
                }
                if(data.image4!='')
                {
                    this.previewImage4='/public/uploads/images/product/' + data.image4;
                }
                if(data.image5!='')
                {
                    this.previewImage5='/public/uploads/images/product/' + data.image5;
                }
            },
            ...
            loadEditProduct()
            {    
                 axios.get("/api/product/"+this.editId).then( ({ data }) => (this.editForm(data)) );
                  //this.loadBrandList();
            },
            ...
            fileSelected1(e){
                if(e.target.files.length > 0 ){
                    ...
                    reader.onloadend = () => {this.iform.pimage1=  reader.result;}
             ...
             fileSelected2(e){
                if(e.target.files.length > 0 ){
                    let file = e.target.files[0];let reader= new FileReader();
                    reader.onloadend = () => {this.iform.pimage2=  reader.result;}
                    reader.readAsDataURL(file);
                }
            },
             fileSelected3(e){
                if(e.target.files.length > 0 ){
                    let file = e.target.files[0];let reader= new FileReader();
                    reader.onloadend = () => {this.iform.pimage3=  reader.result;}
                    reader.readAsDataURL(file);
                }
            },
             fileSelected4(e){
                if(e.target.files.length > 0 ){
                    let file = e.target.files[0];let reader= new FileReader();
                    reader.onloadend = () => {this.iform.pimage4=  reader.result;}
                    reader.readAsDataURL(file);
                }
            },
             fileSelected5(e){
                if(e.target.files.length > 0 ){
                    let file = e.target.files[0];let reader= new FileReader();
                    reader.onloadend = () => {this.iform.pimage5=  reader.result;}
                    reader.readAsDataURL(file);
                }
            },
            ...
            updateProduct(){
               ...
               this.iform.attributex = [];
                for (let x in this.selectedsize){
                    this.iform.attributex.push(this.selectedsize[x].id);
                }

                this.iform.attributesub = [];
                for (let xx in this.selectedcolor){
                    this.iform.attributesub.push(this.selectedcolor[xx].id);
                }

                // console.log(this.iform.attributesub);

                for (let xxx in this.iform){
                    this.multipartForm.append(xxx, this.iform[xxx]);
                }

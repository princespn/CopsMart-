                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                             <router-link to="/DeliveryBoyManagement" class="nav-link"><a type="button" class="btn btn-sm btn-primary mr-3">Delivery Person List </a></router-link>
                        </div>
                    </div>
                    <!-- /.card-header -->
                         ...
                         <form @submit.prevent="updateDeliveryPerson()">
                          ...
                          <div class="form-group row">
                              <div class="col-sm-4">
                                    ...
                                    <v-select   v-model="form.vendor_id" label="name" :options="options"  style="text-transform: capitalize!important;"    :class="{ 'is-invalid': errors.vendor_id }"/>
                                </div>
                               <div class="col-sm-4">

                    ...
                    <div class="card-body table-responsive p-0">
                        ...
                        <table class="table table-bordered table-hover" v-if="reportData.length > 0">
                            ...
                            <tr v-for="txn in reportData" :key="txn.id">
                                ...
                                <td>{{ txn.is_adjustable == true ? 'Yes' : 'No' }}</td>
...
export default {
    ...
    methods :{
        getReportData(){
            this.$Progress.start();
            this.isLoading = true;
            this.form.post('/api/report/franch_wallet/'+this.vendorId).then( ({data})=>{
            ...
            axios.get('/api/franch_wallet/'+this.vendorId+'/wallet/balance').then( ({ data }) => {
                this.wallet = data;

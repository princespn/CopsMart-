    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-12 col-xs-12">
                ...
                <div class="form-group row">
                    <label for="staticEmail" class="col-sm-2 col-form-label">Select Vendor </label>
                    <div class="col-sm-4 col-md-4 ">
...
export default {
    ...
    methods :{
        getReportData(){
            this.$Progress.start();
            this.isLoading = true;
            this.form.post('/api/report/vendor_wallet/'+this.vendorId).then( ({data})=>{
        ...
        loadDeliveryPersonList() {
             var a =$('#authid').val();
            axios.get("/api/vendors?ad="+a).then( ({ data }) => {
                this.vendors = data;
            }).catch( err => console.log(err));
        },

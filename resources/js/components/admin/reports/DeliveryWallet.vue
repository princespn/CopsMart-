<template>
    <div class="container">
        <div class="row">
            <br>
            <h1>Delivery Person wallet Report</h1>
        </div>
        <div class="row">
            <div class="col-12 col-xs-12">
                ...
                <div class="form-group row">
                    <label for="staticEmail" class="col-sm-2 col-form-label">Delivery Person</label>
                    <div class="col-sm-4 col-md-4 ">
                        <select class="form-control" v-model="deliveryPersonId"
                            placeholder=""
...
export default {
    ...
    methods :{
        getReportData(){
            ...
            this.form.post('/api/report/delivery_wallet/'+this.deliveryPersonId).then( ({data})=>{
        ...
        loadDeliveryPersonList() {
             var a =$('#authid').val();
            axios.get("/api/delivery_person?ad="+a).then( ({ data }) => {

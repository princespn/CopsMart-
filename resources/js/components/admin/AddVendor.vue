                            ...
                            <div class="card-header">
                             ...
                             <div class="form-group row">  
                                 <div class="col-sm-4">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-8">
                                    <input type="text"  class="form-control"  v-model="iform.bank_account_number" placeholder="Enter Account Number" :class="{ 'is-invalid': errors.bank_account_number }">
                                        </div>
                                    <div class="col-sm-4 accv" >
                                            <a @click="accountverify()" class="btn p-1 btn-primary">Verify</a>
                                    </div>
                                    <div class="col-sm-4 accvc d-none" >
                                            <a  class="btn p-1  btn-success"><i class="fa fa-check"></i> Verified</a>
                                    </div>
                                    </div>
                    ...
                    <div class="col-sm-4">
                      ...
                      <div class="col-sm-4">
                        ...
                        <div class="col-sm-4">
                                    ...
                                    <input type="password"  class="form-control"  v-model="iform.password" placeholder="Enter Password"  :class="{ 'is-invalid': errors.password }">
                        ...
                        <div class="col-sm-4">
                                    ...
                                    <input type="text"  class="form-control"  v-model="iform.cpassword" placeholder="Enter Confirm Password"  :class="{ 'is-invalid': errors.cpassword }">
                                    <span class="label label-danger" v-if="errors.cpassword">{{errors.cpassword}} </span>
                                </div>
                            </div>
                            <div class="card-header">
    ...
    export default {     
        ...
        methods :{
            createProduct(){
                ...
                this.iform.admin_id = a;
                for (let x in this.iform){
                    this.multipartForm.append(x, this.iform[x]);
                }
                axios.post('/api/vendors', this.multipartForm, config).then( ()=>{
                    toast.fire({
                        type: 'success',
            ...
            fileSelectedshopimg(e){
                if(e.target.files.length > 0 ){
                    ...
                    reader.onloadend = () => {
                        this.iform.shop_image=  reader.result;
                    }
            ...
            fileSelectedworkorder(e){
                if(e.target.files.length > 0 ){
                    ...
                    let reader= new FileReader();
                    reader.onloadend = () => {
                        this.iform.work_order=  reader.result;
                    }
                    reader.readAsDataURL(file);
                }
            },
            ...
            fileSelectedgstcrt(e){
                if(e.target.files.length > 0 ){
                    ...
                    let reader= new FileReader();
                    reader.onloadend = () => {
                        this.iform.gstin_certificate=  reader.result;
                    }
                    reader.readAsDataURL(file);
                }
            },
            ...
            fileSelectedshopact(e){
                if(e.target.files.length > 0 ){
                    ...
                    let reader= new FileReader();
                    reader.onloadend = () => {
                        this.iform.shop_act=  reader.result;
                    }
                    reader.readAsDataURL(file);
                }
            },
            ...
            fileSelectedicon(e){
                if(e.target.files.length > 0 ){
                    ...
                    let reader= new FileReader();
                    reader.onloadend = () => {
                        this.iform.app_icon=  reader.result;
                    }
                    reader.readAsDataURL(file);
                }
            },
            ...
            fileSelectedbank(e){
                if(e.target.files.length > 0 ){
                    ...
                    let reader= new FileReader();
                    reader.onloadend = () => {
                        this.iform.bank_document=  reader.result;
                    }
                    reader.readAsDataURL(file);
                }
            },

        ...
        <div class="row mt-3" >
            <div class="col-12">
                <div class="card p-1" ref="report">
                    ...
                    <div class="card-header">
                        <h3 class="card-title w-100 mb-0 bg-dark text-center">GST-Purchase Summary</h3>
                    </div>
                    <!-- /.card-header -->
...
export default {
    ...
    methods :{
        ...
        getReportData(){
            ...
            this.isLoading = true;
            this.form.post('/api/report/purchasegst').then( ({data})=>{
        ...
        getTotalData()
            {    
                ...
                this.totalDatass.tax=this.totalDatass.tax.toFixed(2);
                this.totalDatass.gst=this.totalDatass.gst.toFixed(2);
                this.totalDatass.total=this.totalDatass.total.toFixed(2);
            },
        download() {
            const doc = new jsPDF();
            /** WITHOUT CSS */

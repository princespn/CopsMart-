            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header"> 
                        <h3 class="card-title ml-3">Push Notification - Notification Text and Images</h3>
                    </div> 
                    <!-- /.card-header-->
                    <div class="card-body p-3">
                         <form @submit.prevent="createProduct()">
                          <div class="form-group row">
                               <div class="col-sm-4">
                                ...
                                <div class="col-sm-4">
                                    <label class="col-form-label">Notofication Description</label>
                         ...
                         <!-- hide coloums -->
                            ...
                            <div class="form-group row brandrow disnone">
                                ...
                                <select class="form-control" v-model="iform.brand_id" placeholder="Select Vendor" :class="{ 'is-invalid': errors.brand_id }" >
                         ...
                         <!-- end -->
                          <div class="form-group row mt-2">
                              ...
                              <div class="col-sm-4">
                                    ...
                                    <input ref="fileInput1" class="form-control" @change="fileSelected" type="file" @input="pickFile1" :class="{ 'is-invalid': errors.images}">
                                    <span class="label label-danger" v-if="errors.images">{{errors.images}} </span>
                                
                              </div>
                              <div class="col-sm-4">
                                   <div class="imagePreviewWrapper" :style="{ 'background-image': `url(${previewImage1})` , 'background-repeat': 'no-repeat' , 'width':'180px' , 'height':'180px' }"
                                      @click="selectImage1">
                                    </div>
                              </div>
                          </div>
    ...
    export default {
        ...
        methods :{
            ...
            createProduct(){
                ...
                axios.post('api/SendNotification', this.multipartForm, config).then( ()=>{
                    toast.fire({
                        type: 'success',

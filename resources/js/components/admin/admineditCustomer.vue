                    ...
                    <div class="card-header">
                        <h3 class="card-title ml-2">Customer Details </h3>
                          <div class="card-tools">
                           <router-link to="/CustomerManagement" class="nav-link"><a type="button" class="btn btn-sm btn-primary mr-3"><i class="fa fa-plus"></i> Add Customer </a></router-link>
                        </div>
                    </div>
                    <!-- /.card-header -->
                         ...
                         <form @submit.prevent="UpdateCustomer()">
                          <div class="form-group row">
                               <div class="col-sm-4">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input type="email"   class="form-control"  v-model="iform.email" placeholder="Enter Identification Mark here" :class="{ 'is-invalid': errors.email }">
                          ...
                          <div class="form-group row">
                              <div class="col-sm-4">
                                ...
                                <div class="col-sm-4" style="margin-left:5px!important">
...
import { log } from 'util';
    export default {
        ...
        methods :{
            ...
            loadEditProduct()
            {    
                axios.get("/api/profile/"+this.editId).then( ({ data }) => (this.editForm(data)) );
            },
            UpdateCustomer(){
                var a =$('#authid').val();
                this.$Progress.start();
                ...
                axios.post('/api/UpdateCustomer/' + this.iform.id, this.multipartForm, config).then( ()=>{
            ...
            editForm(data)
            {
                ...
                if(data.image!='')
                {
                    this.previewImage5='/public/uploads/images/customer/' + data.image;
                }
                this.editMode = true;

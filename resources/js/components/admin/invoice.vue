                ...
                <div class="card p-1" >
                    ...
                    <div class="row card-title m-2 mt-3 "> 
                      ...
                      <div class="col-md-12" style="font-size:14px">
                          ...
                          <div class="row btne bbne">
                              <div class="col-md-6">
                                <h6 class="text-left mt-1">Address: {{orderDetails.vendors.address}}</h6>
                               </div>
                               <div class="col-md-3">
                                <h6 class="text-right blne mt-1">Dist.: {{orderDetails.vendors.district}}</h6>
                               </div>
                               <div class="col-md-3">
                                <h6 class="text-right blne mt-1">State.: {{orderDetails.vendors.state}}</h6>
                               </div>
                          </div>
                      </div>  
                     </div>
                    ...
                    <div class="row card-title mb-0"> 
                       <div class="col-md-4">
                            <h5 class="text-center mb-0 mt-2">Place of Supply.: {{orderDetails.vendors.state}}</h5>
                        </div>
                        <div class="col-md-4 blne bg-black">
                            <h3 class="text-center mb-0 mt-1">TAX INVOICE</h3>
                        </div>
                        <div class="col-md-4 blne">
                            <h6 class="text-left mb-0  mt-1 fw-900">Invoice No.: INV/{{orderDetails.invoice_no}}</h6>
                            <h6 class="text-left mb-0  mt-1 fw-900">Invoice Date.: {{orderDetails.created_at |myDateFormate}}</h6>
                        </div>
                    </div>
                    <hr class=" mt-0 mb-0">
                        ...
                        <hr class="mb-1 mt-1">
                         <div class="row pl-3 ml-2">
                           <div class="col-md-4 row pr-1 br">
                                <div class="row w-100">
                                    <h6 class="col-md-5 mb-0 p-0 text-left">Customer Name </h6>
                                    <h6 class="col-md-1  mb-0 p-0 text-left">:</h6>
                                    <h6 class="col-md-6  mb-0 p-0 text-left">{{orderDetails.user.name}}</h6>
                                </div>
                                <div class="row  w-100 ">
                                    <h6 class="col-md-5  mb-0 p-0 text-left">Bukkle No.</h6>
                                     <h6 class="col-md-1  mb-0 p-0 text-left">:</h6>
                                    <h6 class="col-md-6   mb-0 p-0 text-left">{{orderDetails.user.bukkle_no}}</h6>
                                </div>
                                <div class="row  w-100 ">
                                    <h6 class="col-md-5  mb-0 p-0 text-left">Canteen Card No :</h6>
                                     <h6 class="col-md-1  mb-0 p-0 text-left">:</h6>
                                    <h6 class="col-md-6   mb-0 p-0 text-left">{{orderDetails.user.card_no}}</h6>
                                </div>
                           </div>
                           <div class="col-md-3 pr-1 br row ml-2">
                               <div class="row w-100">
                                    <h6 class="col-md-12 text-center text-primary">Contact Info</h6>
                                </div>
                                 <div class="row w-100 ">
                                    <h6 class="col-md-12 p-0  mb-0 text-center fs-14">@{{orderDetails.user.mobile}}</h6>
                                </div>
                                 <div class="row w-100">
                                    <h6 class="col-md-12 ml-1 p-0  mb-0 text-center fs-14">@{{orderDetails.user.email}}</h6>
                                </div><br>
                           </div>
                           <div class="col-md-5 pr-1 row ml-2">
                               <div class="row w-100">
                                    <h6 class="col-md-12 text-center text-danger">Delivery Address :</h6>
                                </div>
                                 <div class="row w-100 ">
                                    <h6 class="col-md-12  p-0  mb-0 text-center fs-14">{{orderDetails.useraddress.address}}</h6>
                                </div>
                                <hr class="mb-1 w-100 mt-1">
                                 <div class="row w-100 ">
                                    <h6 class="col-md-12  p-0  mb-0 text-center fs-14">Delivery Type: {{orderDetails.delivery_type}}</h6>
                                </div>
                           </div>
                       </div>
                    </div>
                    ...
                    <div class="card-body p-2">
                        <table class="table table-bordered table-hover">
                            ...
                            <tr style="padding: 0.15rem!important">
                                <td colspan="4" style="padding: 0.15rem!important">Total</td>
                                <td style="padding: 0.15rem!important">{{  totalDatas.mrp  }}</td>
                                <td></td>
                                 <td style="padding: 0.15rem!important">{{ calc(totalDatas.sales_rate)  }}</td>
                    ...
                    <div class="row ml-2">
                       <div class="col-md-6 ">
                          <div class="row  p-2">
                           ...
                           <div class="row">
                               ...
                               <p class="mb-0 w-100 text-left" style="font-weight:800;">Canteen timing : {{ orderDetails.vendors.opentime }} to {{ orderDetails.vendors.closetime }}</p>
                                <p class=" mb-0 w-100 text-left" style="font-weight:800;">Canteen will be closed on : {{ orderDetails.vendors.closed }}</p>
                                <p class="mb-0 w-100 text-center mt-1 mb-0" style="font-weight:800;"> ***NO RETURN NO EXCHANGE***</p>
                                <p class="mb-0 w-100">*. You can exchange , if faulty on thesame day of purchase.</p>
                                <p class="mb-0 w-100">*. This is computer generate Invoice and do not need signature.</p>
                           </div>
                       </div>
                       <div class="col-md-2"></div>
                        <div class="col-md-4">
                            ...
                            <div class="row">
                                <div class="col-md-5 text-left p-0"><h5 class="text-primary">Taxable Value  </h5></div>
                                <div class="col-md-1 text-center p-0"><h5 class="text-primary">:</h5></div>
                                <div class="col-md-6 text-left p-0"><h5 >{{calc(parseFloat(this.totalDatas.total_taxable))}}</h5></div>
                            </div>
                             <div class="row">
                                <div class="col-md-5 text-left p-0"><h5 class="text-primary">Total GST  </h5></div>
                                <div class="col-md-1 text-center p-0"><h5 class="text-primary">:</h5></div>
                                <div class="col-md-6 text-left p-0"><h5 >{{calc(parseFloat(this.totalDatas.total_tgst))}}</h5></div>
                            </div>
  
                            <div class="row">
                                <div class="col-md-5 text-left p-0"><h5 class="text-primary">Rebate 50% GST  </h5></div>
                                <div class="col-md-1 text-center p-0"><h5 class="text-primary">:</h5></div>
                                <div class="col-md-6 text-left p-0"><h5 >{{calc(parseFloat(this.totalDatas.total_rtgst))}}</h5></div>
                            </div>
                            <div class="row">
                                <div class="col-md-5 text-left p-0"><h5 class="text-primary">Other Charges  </h5></div>
                                <div class="col-md-1 text-center p-0"><h5 class="text-primary">:</h5></div>
                                <div class="col-md-6 text-left p-0"><h5 >{{calc(parseFloat(this.orderDetails.delivery_charges))}}</h5></div>
                            </div>
                            <div class="row">
                                <div class="col-md-5 text-left p-0"><h5 class="text-primary">Sub Total </h5></div>
                                <div class="col-md-1 text-center p-0"><h5 class="text-primary">:</h5></div>
                                <div class="col-md-6 text-left p-0"><h5 >{{calc((parseFloat(this.totalDatas.total_tgst)+parseFloat(this.totalDatas.total_taxable)+parseFloat(this.orderDetails.delivery_charges))-parseFloat(this.totalDatas.total_rtgst))}}</h5></div>
                            </div>
                            <!-- <hr class="bg-primary"> -->
                            <div class="row">
                                <div class="col-md-5 text-left p-0"><h4><strong>Final Total</strong></h4></div>
                                <div class="col-md-1 text-center p-0"><h5>:</h5></div>
                                <div class="col-md-6 text-left p-0"><h4>{{Math.round((parseFloat(this.totalDatas.total_taxable)+parseFloat(this.totalDatas.total_tgst)+parseFloat(this.orderDetails.delivery_charges))-parseFloat(this.totalDatas.total_rtgst))}}</h4></div>
                            </div>

                            <div class="row mt-2">
                                <div class="col-md-5 text-left p-0"><h5 ><strong>You saved </strong></h5></div>
                                <div class="col-md-1 text-center p-0"><h5>:</h5></div>
                                <div class="col-md-6 text-left p-0"><h5 >{{ (this.totalDatas.mrp - Math.round((parseFloat(this.totalDatas.total_taxable)+parseFloat(this.totalDatas.total_tgst)+parseFloat(this.orderDetails.delivery_charges))-parseFloat(this.totalDatas.total_rtgst))) }}</h5></div>
                            </div>
                        </div>
                    </div>
                    <!-- /.card-body -->

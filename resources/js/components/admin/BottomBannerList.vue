            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title ml-2">Bottom Banner List</h3>

                        <div class="card-tools">
                           
                            <a  href="/vAddBottomBanner" class="btn btn-primary  btn-sm pl-1 mt-1 mr-3" > <i class="fa fa-plus"></i> Add Bottom Banner</a>
                        </div>
                    </div>
                    <!-- /.card-header -->
...
<script>
    ...
    export default {
        ...
        methods :{
            ...
            updateCategory(){
                this.$Progress.start();
                this.form.post('api/UpdateBottomBanner/' + this.form.id).then( ()=>{
            ...
            loadCategoryList() {
                var a =$('#authid').val();
                axios.get("api/BottomBannerData/"+a).then( ({ data }) => (this.categories = data) );
            },
            ...
            deleteCategory(id){
                ...
                swal.fire({
                    ...
                    if(result.value)
                    {
                        this.form.post('/api/deleteBottombanner/'+id).then(() => {
                            swal.fire(
                            'Deleted!',

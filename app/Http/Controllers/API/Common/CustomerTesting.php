...
class CustomerSearchController extends Controller
{
    ...
    function globalSearch(Request $request){
        ...
        $products = VendorProduct::selectRaw("*,vendors.name as vendor_name,vendors.service_range,vendor_products.id as vendor_product_id,products.id as product_id,products.name as product_name,vendor_products.is_active as is_active,vendor_products.is_featured as is_featured,
